          ...
          <div className="block">
            ...
            <section className="highlights">
              ...
              <div className="highlights__text">
                ...
                <p>
                  Estructuras de datos, patrones de diseño, métricas del
                  software, técnicas de refactoring. Todo eso que ves a los
                  demás aplicar y que crees que te falta.{" "}
              ...
              <div className="highlights__text">
                ...
                <p>
                  Este curso te va a ayudar a impulsar tu carrera y a poder
                  optar a posiciones de más nivel.
                </p>
              </div>
            </section>
            <section className="block">
                ...
                <li className="accordion__item accordion__item--collapsed">
                  ...
                  <div className="accordion__content">
                    <p>
                      ...
                      te faltan bases para ascender en tu carrera. Se requiere
                      que sepas programar con algún lenguaje fuertemente tipado.
                    </p>
                    <p>
              ...
              <li className="accordion__item accordion__item--collapsed">
                ...
                <div className="accordion__content">
                  <p>
                    La prueba de acceso es totalmente gratuita y no te
                    compromete a nada ni con el curso ni con la escuela.
                  </p>
                </div>
              </li>
              <li className="accordion__item accordion__item--collapsed">
                ...
                <div className="accordion__content">
                  <p>
                    El precio del curso es de 2.500€. Si eres exalumno/a tienes
                    un descuento de 500€.
                  </p>
                  <p>
