...
const CraftingCourse = (): React.ReactElement => {
    ...
    <>
      <section className="section single-course">
        ...
        <p className="section__subtitle">
          Más que un <strong>bootcamp de programación</strong>. Un curso que te
          llevará <strong>desde cero</strong> al nivel que buscan las{" "}
          <strong>empresas de programación</strong> en un/a junior.
        </p>
        <p className="section__subtitle">
          <strong>Plazas disponibles</strong> para la edición de mayo.
        </p>
        <p className="section__subtitle">
        ...
        <div className="block">
          ...
          <p className="block__text">
            Durante el módulo 1 del curso trabajarás en remoto. Cada lunes se te
            abrirá un reto que tiene diferentes entregas, y tendrás que
          ...
          <p className="block__text">
            ...
            en nuestra oficina de <strong>Gràcia</strong>. Todos los días de la
            semana menos el miércoles, que trabajaremos en remoto desde casa.
            Además de entrenarte para tu próximo trabajo, podrás disfrutar de
            las instalaciones y de los patios para tomar el aire fresco.
          </p>
          <p className="block__text">
            ...
            <div className="highlights__text">
              ...
              <div>
                ...
                <p>
                  ...
                  conjunto de habilidades y conocimientos totalmente enfocados a
                  ayudarte a <strong>encontrar trabajo como developer</strong>.
                </p>
              </div>
            </div>
            <div className="highlights__text">
              ...
              <p>
                ...
                , sino como alguien{" "}
                <strong>totalmente adaptado/a a su manera de trabajar</strong> y
                preparado/a para{" "}
                <strong>
          ...
          <li className="accordion__item accordion__item--collapsed">
            ...
            <div className="accordion__content">
              ...
              <p>
                ...
                parte presencial habiendo rodado ya lo suficiente con el código.
              </p>
            </div>
          </li>
          <li className="accordion__item accordion__item--collapsed">
            ...
            <div className="accordion__content">
              ...
              <p>
                El segundo módulo dura 12 semanas y es presencial, en Barcelona
                capital.
              </p>
            </div>
          </li>
        ...
        <li className="accordion__item accordion__item--collapsed">
          ...
          <div className="accordion__content">
            <p>
              ...
              pagar nada hasta encontrar trabajo. Ponte en contacto con nosotros
              y vemos tu caso.
            </p>
          </div>
        </li>
